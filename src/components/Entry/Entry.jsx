    ...
    <div>
      ...
      <div className={classNames(styles.shareList)}>
        ...
        <div className={classNames(styles.shareIcon)}>
          <span>{_getFacebookIcon()}</span>
        </div>
        <div className={classNames(styles.shareIcon)}>
          <span>{_getLinkedinIcon()}</span>
        </div>
        <div className={classNames(styles.shareIcon)}>
          <span>{_getGplusIcon()}</span>
        </div>
      </div>
    </div>
  );
...
const _getGplusIcon = () => {
  return (
    <span
      ...
      onClick={() => {
        window.open(
          "https://plus.google.com/share?url=" + _getShareUrl("googleplus"),
          "_blank"
        );
      }}
    >
